...
CREATE TABLE public.admins (
    ...
    admin_nombre character varying NOT NULL,
...
COPY public.admins (admin_id, admin_nombre, admin_user, admin_password) FROM stdin;
1	ADMIN SUPREMO DEL UNIVERSO	admin	admin
\.
...
COPY public.tecnicos (tecnico_id, tecnico_nombre, tecnico_user, tecnico_password, tecnico_activo) FROM stdin;
